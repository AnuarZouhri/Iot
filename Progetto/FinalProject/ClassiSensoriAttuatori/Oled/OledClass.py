...
""" Classe per gestire lo schermo oled """
class Oled:
    ...
    """ Mostra sullo schermo quanto indicato in text, in posizione (x,y), di colore color_background e con clean si sceglie se rimuovere
        o meno quanto già presente sullo schermo """
    ...
    """ Mostra quanto scritto sullo schermo """
    def show(self):
        self.display.show()
    
    """ Mostra il logo con luchetto chiuso """
    def writeLogo(self):
        fb = framebuf.FrameBuffer(logo_lock, 128, 64, framebuf.MONO_HLSB)
        self.display.fill(0)
        self.display.blit(fb, 8, 0)
        
    """ Mostra il logo con luchetto aperto """
